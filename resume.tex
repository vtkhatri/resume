	...
	\resumeSubHeadingListStart
		\resumeSubheading
			...
			\resumeItemListStart
				...
				\resumeItem{Feature Development}{Implemented Zero Touch In-Band Management feature request by Tejas Network's client with specification inputs from the Sales team and feedback from QA team.}
...
\section{Projects}
	...
	\resumeSubHeadingListStart
		...
		\resumeSubItem{\href{https://github.com/vtkhatri/dram-controller}{dram-controller}}{A bank parallel DDR4 memory controller with access scheduling. Written in System Verilog.}
