...
% OBJECTIVE
\section{Objective}
CPU Core Verification Internship
...
\section{Projects}
	...
	\resumeSubHeadingListStart
		...
		\resumeSubItem{\href{https://github.com/vtkhatri/fifo}{fifo}}{A parameterized multi-port fifo for simultaneous reads and writes.}
		\resumeSubItem{\href{https://github.com/vtkhatri/ffind}{ffind}}{A wrapper for find command in linux to make it accept grep-like arguments. Written in golang and rust.}
