...
% Resume in Latex
% Author : Viraj Khatri
% Based on: https://github.com/samuelgonsalves/resume
%------------------------
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
	\textbf{\href{https://linktr.ee/wilmerags}{\Large Viraj Khatri}} &  \href{https://github.com/vtkhatri}{ \faicon{github} \color{urlcolor} vtkhatri} \\
...
\section{Education}
	\resumeSubHeadingListStart
		\resumeSubheading
			{Portland State University, Portland, OR}{ - / 4.0}
			{M.Sc Electrical and Computer Engineering}{Fall 2021 -- Spring 2023}
			\resumeItemListStart
			...
			\resumeItemListEnd
		\resumeSubheading
			{College of Engineering, Pune, Maharashtra, India}{ 3.2 / 4.0}
			{B.Tech Electronics and Telecommunication Engineering}{May 2015 -- June 2019}
...
\section{Experience}
	\resumeSubHeadingListStart
		\resumeSubheading
			...
			\resumeItemListStart
				\resumeItem{Integrated a new network switching product into Tejas ecosystem.}
				\resumeItem{Lead Engineer on implementation of feature request by Tejas network's clients.}
				\resumeItem{Train new recruits to the team and enable them to contribute meaningfully.}
			\resumeItemListEnd
				\resumeTech{Technologies}{C/C++, Bash, SQL, and Python.}\\
				\resumeTech{Theory}{Device Drivers, VLAN traffic filtering, DHCP, and Bandwidth Management.}

		\resumeSubheading
			{DOT Sys Technologies}{Mumbai, Maharashtra, India}
			{Design Intern}{May 2018 - August 2018}
			\resumeItemListStart
				\resumeItem{Programmable Battery Charger - }
			\resumeItemListEnd
			\resumeTech{Technologies}{Arduino.}\\
			\resumeTech{Theory}{Transistor theory and Analog Circuits.}
     
		\resumeSubheading
			{Eduvance}{Mumabai, Maharashtra, India}
			{Intern (part-time to full-time)}{May 2017 - January 2020}
			\resumeItemListStart
				\resumeItem{Developed a Smart Paper Tracking System.}
				\resumeItem{Presented my B.Tech Final Project.}
			\resumeItemListEnd
			\resumeTech{Technologies}{Python, Cypress PSOC4.}\\
			\resumeTech{Theory}{Internet of Things, Bluetooth Low Energy, and Communication Protocols.}
...
\section{Projects}
	...
	\resumeSubHeadingListStart
		...
		\resumeSubItem{\href{https://github.com/vtkhatri/goland}{ffind}: Small wrapper for find command in linux to make find accept grep-like arguments.}
