	...
	\resumeSubHeadingListStart
		\resumeSubheading
			...
			\resumeItemListStart
				...
				\resumeItem{SQL}{Switching Configuration stored on the network cards is in a database, which needs to be created, updated, or re-played onto the hardware as required.}
			\resumeItemListEnd
